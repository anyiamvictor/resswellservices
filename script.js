...
// Smooth scroll on click + activate instantly
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Helper: Activate link by section ID
  function activateLinkById(id) {
    clearActive();
  ...
  navLinks.forEach((link) => {
    link.addEventListener("click", (e) => {
      ...
      if (targetSection) {
        // Disable scroll detection temporarily while clicking
        isScrolling = true;
        activateLinkById(targetId);
  ...
  // Auto update nav highlight on scroll
